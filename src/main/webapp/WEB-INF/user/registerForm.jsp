...
<div class="container">
   ...
   <form name="form" method="POST" action="<c:url value='/user/register'/>">
      ...
      <div class="form-group row">   
       ...
       <div class="form-group row">   
           <label for="birth" class="col-lg-2 col-form-label">생년월일</label>
           <div class="col-lg-10">
                <input type="text" name="birth" class="form-control" placeholder="ex)20000101">
           </div>
       </div> 
        <div class="form-group row">   
           <label for="address" class="col-lg-2 col-form-label">주소</label>
           <div class="col-lg-10">
               <input type="text" name="address" class="form-control" placeholder="주소지"
      ...
      <div class="form-group row">  
       ...
       <div class="form-group row">  
           <label for="local" class="col-lg-2 col-form-label">활동 지역</label>
           <div class="col-lg-10">
              <select name="local">
                 <option>-선택-</option>
       ...
       <div class="form-group row">  
           <label for="interest" class="col-lg-2 col-form-label">관심사</label>
           <div class="col-lg-10">
              요리<input type="checkbox" name="interest" value="요리">
               수공예<input type="checkbox" name="interest" value="수공예">
               미술<input type="checkbox" name="interest" value="미술">
               스포츠<input type="checkbox" name="interest" value="스포츠">
           </div>
       </div>
      <br>
